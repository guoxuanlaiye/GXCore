...
// 是否空对象
#define IS_NULL_CLASS(OBJECT)   ([OBJECT isKindOfClass:[NSNull class]] || OBJECT == nil)
...
//字符串是否为空
#define kStringIsEmpty(str)  (([str isKindOfClass:[NSNull class]] || str == nil || [src isEqualToString:@"(null)"] || [src isEqualToString:@"<null>"] || [str length] < 1) ? YES : NO )
//数组是否为空
